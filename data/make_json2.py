# https://github.com/pjsier/cta-gl-trips/blob/master/data/process_gtfs.py
...
START_TIME = get_seconds('05:25:00')
...
if __name__ == '__main__':
    BASE_DIR = BASE_DIR + "./ryobi/"
    # print(os.path.join(BASE_DIR, 'shapes.txt'))
    ...
    with open(os.path.join(BASE_DIR, 'trip_line_segments.json'), 'w') as trip_f:
        json.dump(trip_segment_list, trip_f, ensure_ascii=False)